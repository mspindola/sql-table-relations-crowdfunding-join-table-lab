...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  ...
  #reaches into projects and gets name, creates an operation p.amount - pfundinggoal AS (aslising the return value as amount left, from the projects table, joins pledges at the pid value  groups title of projects that have more or equal funding ammount)
end
